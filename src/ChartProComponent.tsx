...
const ChartProComponent: Component<ChartProComponentProps> = (props) => {
  ...
  onMount(() => {
    ...
    if (widget) {
      ...
      if (watermarkContainer) {
        ...
        watermark.className = "tradingsoccerwrap-watermark";
      ...
      priceUnitDom.className = "tradingsoccerwrap-price-unit";
  ...
  createEffect((prev?: PrevSymbolPeriod) => {
    if (!loading) {
      ...
      const get = async () => {
        const [to] = adjustFromTo(p, new Date().getTime(), 1);
        const [from] = adjustFromTo(p, 1000000000000, 1);
  ...
  return (
    <>
      <i class="icon-close tradingsoccerwrap-load-icon" />
      ...
      />
      <div class="tradingsoccerwrap-content">
        ...
        <div ref={widgetRef} class="tradingsoccerwrap-widget" data-drawing-bar-visible={drawingBarVisible()} />
      </div>
    </>
  );
};
