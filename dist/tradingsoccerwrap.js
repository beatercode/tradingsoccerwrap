...
var m1 = (e, t, n) => (g5(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as E, init as y5, FormatDateType as K1, DomPosition as K0, ActionType as m5, dispose as h5, TooltipIconPosition as j1, registerOverlay as d5 } from "tradingsoccerlib";
function D1(e, t, n) {
...
const p5 = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = A9(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = E.getLinearSlopeIntercept(e[0], e[1]);
      let s;
      ...
      for (let f = 2; f < 9; f++) {
        ...
        const k = b + Math.PI / 2, Z = D1({ x: C, y: l }, e[0], s);
        c.push({
          ...Z,
          r: p,
          startAngle: b,
...
var F = null;
let C0 = null, K5 = null, O = null, Y = null, a1 = null, e0 = 0;
function R1(e, t) {
  const n = O, r = F, a = e.length === 0, s = t === void 0 ? r : t, o = a ? w9 : {
    owned: null,
    cleanups: null,
...
function r1(e, t, n) {
  k9 = U5;
  const r = t0(e, t, !1, i1);
  (!n || !n.render) && (r.user = !0), a1 ? a1.push(r) : d1(r);
}
function j(e, t, n) {
  n = n ? Object.assign({}, U1, n) : U1;
  const r = t0(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, d1(r), S9.bind(r);
}
function j5(e) {
...
function F5(e, t, n) {
  ...
  function $(D, S, P, J) {
    return o === D && (o = null, J !== void 0 && (C = !0), (D === i || S === i) && s.onHydrated && queueMicrotask(
      () => s.onHydrated(J, {
        value: S
      })
    ), i = u0, x(S, P)), S;
  ...
  function x(D, S) {
    c1(() => {
      S === void 0 && b(() => D), M(S !== void 0 ? "errored" : C ? "ready" : "unresolved"), Z(S);
  ...
  function I() {
    ...
    if (P !== void 0 && !o)
      throw P;
    return O && !O.user && D && j0(() => {
      K(), o && (D.resolved || f.has(D) || (D.increment(), f.add(D)));
    }), S;
  }
  function V(D = !0) {
    if (D !== !1 && c)
    ...
    return j5(P) ? (o = P, "value" in P ? (P.status === "success" ? $(o, P.value, void 0, S) : $(o, void 0, void 0, S), P) : (c = !0, queueMicrotask(() => c = !1), c1(() => {
...
function Z5(e) {
  ...
  return Promise.resolve().then(() => {
    O = t, F = n;
    let r;
    return c1(e, !1), O = F = null, r ? r.done : void 0;
  });
}
let Q5;
function S9() {
...
function H1(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    ...
    if (r.sources) {
      const a = r.state;
      a === i1 ? r !== t && (!r.updatedAt || r.updatedAt < e0) && V1(r) : a === Y1 && H1(r, t);
    }
  }
}
function D9(e) {
...
function V5(e, t, n = {}) {
  ...
  return x0(() => F0(s)), () => {
    ...
    return c[N5], q(() => {
      ...
      if (p === 0)
        o !== 0 && (F0(s), s = [], r = [], a = [], o = 0, i && (i = [])), n.fallback && (r = [Y5], a[0] = R1((I) => (s[0] = I, n.fallback())), o = 1);
      else if (o === 0) {
...
function G1(e, t, n, r, a) {
  ...
  if (e = o && n[0] && n[0].parentNode || e, s === "string" || s === "number")
    if (s === "number" && (t = t.toString()), o) {
      let i = n[0];
      i && i.nodeType === 3 ? i.data !== t && (i.data = t) : i = document.createTextNode(t), n = h1(e, n, r, i);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (i.length === 0) {
        ...
        c ? n.length === 0 ? Q0(e, i, r) : W5(e, n, i) : (n && h1(e), Q0(e, i));
      n = i;
    } else if (t.nodeType) {
      if (Array.isArray(n)) {
        if (o)
...
var t6 = typeof Z1 == "object" && Z1 && Z1.Object === Object && Z1, N9 = t6, n6 = N9, r6 = typeof self == "object" && self && self.Object === Object && self, a6 = n6 || r6 || Function("return this")(), t1 = a6, i6 = t1, s6 = i6.Symbol, r0 = s6, R0 = r0, K9 = Object.prototype, o6 = K9.hasOwnProperty, c6 = K9.toString, I1 = R0 ? R0.toStringTag : void 0;
function l6(e) {
  var t = o6.call(e, I1), n = e[I1];
  try {
    e[I1] = void 0;
    var r = !0;
  } catch {
...
var v1 = _6, L6 = P1, b6 = v1, $6 = "[object AsyncFunction]", x6 = "[object Function]", A6 = "[object GeneratorFunction]", k6 = "[object Proxy]";
function w6(e) {
  if (!b6(e))
    return !1;
  var t = L6(e);
...
var F9 = O6, E6 = j9, N6 = D6, K6 = v1, j6 = F9, F6 = /[\\^$.*+?()[\]{}|]/g, Z6 = /^\[object .+?Constructor\]$/, Q6 = Function.prototype, R6 = Object.prototype, z6 = Q6.toString, U6 = R6.hasOwnProperty, Y6 = RegExp(
...
var k0 = l2, u2 = Array.isArray, _1 = u2;
function C2(e) {
  return e != null && typeof e == "object";
}
var L1 = C2, f2 = P1, g2 = L1, y2 = "[object Symbol]";
function m2(e) {
  return typeof e == "symbol" || g2(e) && f2(e) == y2;
}
var w0 = m2, h2 = _1, d2 = w0, p2 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, v2 = /^\w*$/;
function _2(e, t) {
  if (h2(e))
    return !1;
  var n = typeof e;
...
var L2 = _2, b2 = g1, $2 = b2(Object, "create"), a0 = $2, H0 = a0;
function x2() {
...
var Q2 = Z2, R2 = A2, z2 = w2, U2 = P2, Y2 = K2, V2 = Q2;
function b1(e) {
...
b1.prototype.clear = R2;
b1.prototype.delete = z2;
b1.prototype.get = U2;
b1.prototype.has = Y2;
b1.prototype.set = V2;
var H2 = b1;
...
$1.prototype.clear = g3;
$1.prototype.delete = y3;
$1.prototype.get = m3;
$1.prototype.has = h3;
$1.prototype.set = d3;
var s0 = $1, p3 = g1, v3 = t1, _3 = p3(v3, "Map"), M0 = _3, G0 = H2, L3 = s0, b3 = M0;
function $3() {
...
x1.prototype.clear = Z3;
x1.prototype.delete = Q3;
x1.prototype.get = R3;
x1.prototype.has = z3;
x1.prototype.set = U3;
var R9 = x1, z9 = R9, Y3 = "Expected a function";
function S0(e, t) {
...
S0.Cache = z9;
var V3 = S0, H3 = V3, G3 = 500;
function X3(e) {
  var t = H3(e, function(r) {
...
var ae = re, X0 = r0, ie = ae, se = _1, oe = w0, ce = 1 / 0, J0 = X0 ? X0.prototype : void 0, W0 = J0 ? J0.toString : void 0;
function U9(e) {
  if (typeof e == "string")
    return e;
  if (se(e))
...
var fe = Ce, ge = _1, ye = L2, me = ne, he = fe;
function de(e, t) {
...
var Ae = xe, ke = k0, we = pe, Me = Y9, q0 = v1, Se = Ae;
function Te(e, t, n, r) {
  if (!q0(e))
    return e;
  t = we(t, e);
...
var Re = Qe, ze = s0, Ue = M0, Ye = R9, Ve = 200;
function He(e, t) {
  var n = this.__data__;
  if (n instanceof ze) {
    var r = n.__data__;
...
var Ge = He, Xe = s0, Je = Ne, We = je, qe = Ze, e8 = Re, t8 = Ge;
function A1(e) {
  var t = this.__data__ = new Xe(e);
  this.size = t.size;
}
A1.prototype.clear = Je;
A1.prototype.delete = We;
A1.prototype.get = qe;
A1.prototype.has = e8;
A1.prototype.set = t8;
var n8 = A1;
...
var l8 = c8, u8 = P1, C8 = L1, f8 = "[object Arguments]";
function g8(e) {
  return C8(e) && u8(e) == f8;
}
var y8 = g8, e9 = y8, m8 = L1, V9 = Object.prototype, h8 = V9.hasOwnProperty, d8 = V9.propertyIsEnumerable, p8 = e9(function() {
  return arguments;
}()) ? e9 : function(e) {
...
var H9 = X1.exports, b8 = 9007199254740991;
function $8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= b8;
}
var G9 = $8, x8 = P1, A8 = G9, k8 = L1, w8 = "[object Arguments]", M8 = "[object Array]", S8 = "[object Boolean]", T8 = "[object Date]", I8 = "[object Error]", D8 = "[object Function]", P8 = "[object Map]", B8 = "[object Number]", O8 = "[object Object]", E8 = "[object RegExp]", N8 = "[object Set]", K8 = "[object String]", j8 = "[object WeakMap]", F8 = "[object ArrayBuffer]", Z8 = "[object DataView]", Q8 = "[object Float32Array]", R8 = "[object Float64Array]", z8 = "[object Int8Array]", U8 = "[object Int16Array]", Y8 = "[object Int32Array]", V8 = "[object Uint8Array]", H8 = "[object Uint8ClampedArray]", G8 = "[object Uint16Array]", X8 = "[object Uint32Array]", B = {};
B[Q8] = B[R8] = B[z8] = B[U8] = B[Y8] = B[V8] = B[H8] = B[G8] = B[X8] = !0;
B[w8] = B[M8] = B[F8] = B[S8] = B[Z8] = B[T8] = B[I8] = B[D8] = B[P8] = B[B8] = B[O8] = B[E8] = B[N8] = B[K8] = B[j8] = !1;
function J8(e) {
  return k8(e) && A8(e.length) && !!B[x8(e)];
}
var W8 = J8;
function q8(e) {
  return function(t) {
...
var I0 = J1.exports, e7 = W8, t7 = T0, t9 = I0, n9 = t9 && t9.isTypedArray, n7 = n9 ? t7(n9) : e7, r7 = n7, a7 = l8, i7 = v8, s7 = _1, o7 = H9, c7 = Y9, l7 = r7, u7 = Object.prototype, C7 = u7.hasOwnProperty;
function f7(e, t) {
...
var N7 = E7, K7 = v1, j7 = D0, F7 = N7, Z7 = Object.prototype, Q7 = Z7.hasOwnProperty;
function R7(e) {
  if (!K7(e))
    return F7(e);
  var t = j7(e), n = [];
...
var z7 = R7, U7 = X9, Y7 = z7, V7 = W9;
function H7(e) {
  return V7(e) ? U7(e, !0) : Y7(e);
}
var B0 = H7, G7 = c0, X7 = B0;
function J7(e, t) {
...
var jt = Kt, Ft = g1, Zt = t1, Qt = Ft(Zt, "DataView"), Rt = Qt, zt = g1, Ut = t1, Yt = zt(Ut, "Promise"), Vt = Yt, Ht = g1, Gt = t1, Xt = Ht(Gt, "Set"), Jt = Xt, Wt = g1, qt = t1, e4 = Wt(qt, "WeakMap"), t4 = e4, v0 = Rt, _0 = M0, L0 = Vt, b0 = Jt, $0 = t4, a5 = P1, k1 = F9, a9 = "[object Map]", n4 = "[object Object]", i9 = "[object Promise]", s9 = "[object Set]", o9 = "[object WeakMap]", c9 = "[object DataView]", r4 = k1(v0), a4 = k1(_0), i4 = k1(L0), s4 = k1(b0), o4 = k1($0), C1 = a5;
(v0 && C1(new v0(new ArrayBuffer(1))) != c9 || _0 && C1(new _0()) != a9 || L0 && C1(L0.resolve()) != i9 || b0 && C1(new b0()) != s9 || $0 && C1(new $0()) != o9) && (C1 = function(e) {
  var t = a5(e), n = t == n4 ? e.constructor : void 0, r = n ? k1(n) : "";
  if (r)
    switch (r) {
      case r4:
        return c9;
...
var W4 = J4, q4 = v1, g9 = Object.create, en = function() {
  function e() {
  }
  return function(t) {
    if (!q4(t))
...
function z1(e, t, n, r, a, s) {
  ...
  var k = C ? c ? En : On : c ? Vn : Yn, Z = l ? void 0 : k(e);
...
const Mr = (e) => (() => {
  ...
  return o1(t, "click", e.onClick, !0), d(t, () => e.children), R((n) => {
    ...
    return n.e = p1(t, r, n.e), a !== n.t && f1(t, n.t = a), n;
  }, {
    e: void 0,
    t: void 0
  }), t;
...
const Pr = () => Sr(), Br = () => Tr(), p9 = (e) => {
  ...
  return r1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a.e = p1(r, s, a.e), o !== a.t && f1(r, a.t = o), a;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
const l5 = (e) => {
  ...
  return (() => {
    ...
    return r.addEventListener("blur", (o) => {
      ...
      return o.e = p1(r, i, o.e), c !== o.t && f1(r, o.t = c), o;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
e1(["click"]);
var Ur = /* @__PURE__ */ y("<span class=prefix>"), Yr = /* @__PURE__ */ y("<span class=suffix>"), Vr = /* @__PURE__ */ y("<div><input class=value>");
const u5 = (e) => {
  const t = O9({
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      return i.e = p1(s, c, i.e), C !== i.t && f1(s, i.t = C), l !== i.a && H(s, "data-status", i.a = l), f !== i.o && H(o, "placeholder", i.o = f), i;
    }, {
      e: void 0,
      t: void 0,
      a: void 0,
...
e1(["click"]);
var Hr = /* @__PURE__ */ y("<div><i class=thumb>");
const Gr = (e) => (() => {
  var t = Hr();
  return t.$$click = (n) => {
    ...
    return A0((x) => {
      ...
      get children() {
        ...
        return o1(x, "click", e.onSymbolClick, !0), d(x, h(U, {
          ...
          get children() {
            var V = Cc();
            return R(() => H(V, "src", e.symbol.logo)), V;
          }
        }), I), d(I, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), x;
      }
    }), c), d(s, () => e.periods.map((x) => (() => {
      var I = y0();
      return I.$$click = () => {
        e.onPeriodChange(x);
      }, d(I, () => x.text), R(() => f1(I, `item period ${x.text === e.period.text ? "selected" : ""}`)), I;
      ...
      return () => x() ? [yc(), (() => {
        var I = y0();
        return d(I, () => u("exit_full_screen", e.locale)), I;
      })()] : [mc(), (() => {
        var I = y0();
        return d(I, () => u("full_screen", e.locale)), I;
      })()];
    })()), R(() => H(i, "class", e.spread ? "" : "rotate")), s;
  })();
};
e1(["click"]);
...
const xl = (e) => (() => {
  var t = $l();
  return H(t, "class", `icon-overlay ${e ?? ""}`), t;
})();
...
const _9 = "drawing_tools", Yl = (e) => {
  ...
  return (() => {
    var V = zl(), D = V.firstChild, S = D.nextSibling, P = S.firstChild, J = P.nextSibling, l0 = J.firstChild, M1 = S.nextSibling, S1 = M1.firstChild, l1 = M1.nextSibling, B1 = l1.firstChild, O1 = l1.nextSibling, E1 = O1.nextSibling, N1 = E1.firstChild;
    return d(V, () => x().map((A) => (() => {
      var z = Ul(), W = z.firstChild, s1 = W.nextSibling, T1 = s1.firstChild;
      ...
      })(), null), R(() => H(T1, "class", A.key === M() ? "rotate" : "")), z;
    })()), D), S.addEventListener("blur", () => {
      $("");
    }), P.$$click = () => {
      let A = f();
...
const Gl = (e) => {
  const [t, n] = L(e.timezone), r = j(() => Hl(e.locale));
  return h(w1, {
    get title() {
...
const au = (e) => {
  const [t, n] = L(E.clone(e.params.calcParams)), r = (a) => tu[a];
  return h(w1, {
    get title() {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          E.clone(t()).forEach((o, i) => {
            !E.isValid(o) || o === "" ? "default" in a[i] && s.push(a[i].default) : s.push(o);
      ...
      return [h(u5, {
        ...
        renderItem: (a) => (() => {
          ...
          return s.$$click = () => {
            ...
            get children() {
              var c = su();
              return R(() => H(c, "src", a.logo)), c;
            }
          }), i), d(i, () => a.shortName ?? a.ticker, null), d(i, () => `${a.name ? `(${a.name})` : ""}`, null), d(s, () => a.exchange ?? "", null), R(() => H(i, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
const Cu = (e) => {
  let t, n = null, r, a = !1;
  const [s, o] = L(e.theme), [i, c] = L(e.styles), [C, l] = L(e.locale), [f, p] = L(e.symbol), [b, k] = L(e.period), [Z, K] = L(!1), [w, Q] = L([...e.mainIndicators]), [M, $] = L({}), [x, I] = L(!1), [V, D] = L({
    key: e.timezone,
    text: $9(e.timezone, e.locale)
  }), [S, P] = L(!1), [J, l0] = L(), [M1, S1] = L(""), [l1, B1] = L(e.drawingBarVisible), [O1, E1] = L(!1), [N1, A] = L(!1), [z, W] = L({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const s1 = () => {
    ...
    switch (m.timespan) {
      case "minute": {
        _ = _ - _ % (60 * 1e3), N = _ - v * m.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        _ = _ - _ % (60 * 60 * 1e3), N = _ - v * m.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        _ = _ - _ % (60 * 60 * 1e3), N = _ - v * m.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        ...
        _ = _ - u1 * 60 * 60 * 24;
        const y1 = new Date(_);
        _ = (/* @__PURE__ */ new Date(`${y1.getFullYear()}-${y1.getMonth() + 1}-${y1.getDate()}`)).getTime(), N = v * m.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const n1 = new Date(_), G = n1.getFullYear(), u1 = n1.getMonth() + 1;
        _ = (/* @__PURE__ */ new Date(`${G}-${u1}-01`)).getTime(), N = v * m.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const y1 = new Date(N);
        N = (/* @__PURE__ */ new Date(`${y1.getFullYear()}-${y1.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const G = new Date(_).getFullYear();
        _ = (/* @__PURE__ */ new Date(`${G}-01-01`)).getTime(), N = v * m.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const u1 = new Date(N);
        N = (/* @__PURE__ */ new Date(`${u1.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [N, _];
  ...
  return M9(() => {
    if (window.addEventListener("resize", s1), n = y5(t, {
      customApi: {
        formatDate: (g, v, _, N) => {
          switch (b().timespan) {
            case "minute":
              return N === K1.XAxis ? E.formatDate(g, v, "HH:mm") : E.formatDate(g, v, "YYYY-MM-DD HH:mm");
            case "hour":
              return N === K1.XAxis ? E.formatDate(g, v, "MM-DD HH:mm") : E.formatDate(g, v, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return E.formatDate(g, v, "YYYY-MM-DD");
            case "month":
              return N === K1.XAxis ? E.formatDate(g, v, "YYYY-MM") : E.formatDate(g, v, "YYYY-MM-DD");
            case "year":
              return N === K1.XAxis ? E.formatDate(g, v, "YYYY") : E.formatDate(g, v, "YYYY-MM-DD");
          }
          return E.formatDate(g, v, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      ...
      if (g) {
        ...
        if (_.className = "tradingsoccerwrap-watermark", E.isString(e.watermark)) {
          const N = e.watermark.replace(/(^\s*)|(\s*$)/g, "");
          _.innerHTML = N;
        } else
    ...
    e.subIndicators.forEach((g) => {
      ...
      a = !0, (async () => {
        const _ = b(), [N] = T1(_, g, 1), [n1] = T1(_, N, 500), G = await e.datafeed.getHistoryKLineData(f(), _, n1, N);
    ...
    if (!a) {
      ...
      return a = !0, A(!0), (async () => {
        const [N, n1] = T1(v, (/* @__PURE__ */ new Date()).getTime(), 500), G = await e.datafeed.getHistoryKLineData(g, v, N, n1);
    ...
    onMenuClick: async () => {
      try {
        await Z5(() => B1(!l1())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    var v = t;
    return typeof v == "function" ? A0(v, g) : t = g, R(() => H(g, "data-drawing-bar-visible", l1())), m;
  })()];
};
